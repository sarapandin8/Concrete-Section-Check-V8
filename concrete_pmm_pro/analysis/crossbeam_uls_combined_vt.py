...
def _section_combined_row(
    ...
    *,
    ...
    return {
        ...
        "Torsion threshold status": str(torsion_row.get("Threshold status") or ""),
        "Torsion threshold D/C value": _finite(torsion_row.get("Threshold D/C value")),
        "phiTth kN-m": _finite(torsion_row.get("phiTth kN-m")),
